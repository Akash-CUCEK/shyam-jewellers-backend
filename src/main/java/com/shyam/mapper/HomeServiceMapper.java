...
public class HomeServiceMapper {
    ...
    public static GetAllHomeServiceResponseDTO getAllHomeServiceRequests(List<ServiceHome> services) {
        List<HomeServiceResponseDTO> responseList = services.stream()
        ...
        return GetAllHomeServiceResponseDTO.builder()
                .getAllServices(responseList)
                .build();
    }
    ...
    public static ServiceHome editHomeServiceRequest(ServiceHome service, EditHomeServiceRequestDTO dto) {
        service.setName(dto.getName());
        service.setAddress(dto.getAddress());

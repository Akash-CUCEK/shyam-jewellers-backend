...
public class RepairRequestMapper {
    public static GetAllRepairResponseDTO getAllRepairRequests(List<RepairService> repairRequest) {
        List<RepairRequestResponseDTO> listRequest = repairRequest.stream()
                .map(service -> RepairRequestResponseDTO.builder()
        ...
        return GetAllRepairResponseDTO.builder()
                .getAllServices(listRequest)
                .build();
    }
    ...
    public static CreateRepairResponseDTO maoToCreatRepairRequestResponseDTO(String message) {
        return CreateRepairResponseDTO.builder()
                .response(message)
                .build();
    }

    public static RepairService editRepairRequest(RepairService service, EditRepairRequestDTO editRepairRequestDTO) {
